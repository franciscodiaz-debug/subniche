...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-background">
      ...
      {/* Hero copy */}
      <div className="px-4 pb-10 pt-2 md:px-8 md:pb-12 md:pt-4">
        ...
        <p className="mt-3 max-w-xl text-pretty text-sm leading-relaxed text-muted-foreground md:text-base">
          Welcome back, Jordan &mdash; your crew&apos;s been busy. Fresh listings,
          new trade matches, and a few rare finds are waiting for you.
        </p>
