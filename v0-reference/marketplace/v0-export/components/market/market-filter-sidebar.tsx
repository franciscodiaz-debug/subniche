...
export function MarketFilterSidebar({
  ...
  // Follow the main nav's collapsed state so the filter panel sits
  // flush against the nav's right edge on desktop.
  ...
  const selectedCategory = marketCategories.find((c) => c.id === filters.category)
